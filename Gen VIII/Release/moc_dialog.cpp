...
QT_MOC_LITERAL(1, 7, 15), // "evolutionNumber"
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Dialog::*)(const int & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dialog::evolutionNumber)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Dialog::evolutionNumber(const int & _t1)
{
