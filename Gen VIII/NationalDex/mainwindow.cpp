...
MainWindow::MainWindow(QWidget *parent)
    ...
    galarVect  = pokedex->GetRegion(   globalPDexConsts::ALOLA_DEX,
                                       globalPDexConsts::GALAR_DEX);
...
void MainWindow::on_galarButton_clicked() {this->galarUi->showMaximized();}
...
void MainWindow::CatchSignal(const int& POKEMON_NUMBER)
{
    ...
    else if(POKEMON_NUMBER < GALAR_START){
