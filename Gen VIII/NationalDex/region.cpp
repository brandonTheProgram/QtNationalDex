...
void Region::CreateList(){
    unsigned int regionSize = this->regionVect.size(); //PROC - size of the region
...
void Region::PrintList() const{
    int regionSize = this->list.size(); //PROC - size of the list
...
void Region::GoToDialog(){
    ...
    int regionSize = this->list.size(); //PROC - size of the region
