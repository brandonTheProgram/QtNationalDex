 ...
 * ------------------------------------------------------------------------
 * SINNOH_AR_SIZE	: The size of the array/vector
 * ------------------------------------------------------------------------
 * USED FOR SPECIFIC VALUES
 * ------------------------------------------------------------------------
 * SINNOH_START	: The starting index in the region pokedex
 *************************************************************************/

const int SINNOH_AR_SIZE = 107;
const int SINNOH_START = 387;

//namespace holding the path to the sinnoh pokemon images
namespace SinnohImages {
...
/************************************************************************
* Sinnoh Class
* 	This class represents the Sinnoh region screen. It manages 8 attributes:
* 		ui, scrollArea, gridLayout, mainLayout, list, mainWidget,
*       pokemonDialog, regionVect
*************************************************************************/
class Sinnoh : public QMainWindow
{
    Q_OBJECT

public:
    //Constructor
    explicit Sinnoh(QWidget *parent = nullptr);
...
private:
    Ui::Sinnoh           *ui;           //The UI for the region
