 ...
 * ------------------------------------------------------------------------
 * KANTO_AR_SIZE	: The size of the array/vector
 *************************************************************************/
const int KANTO_AR_SIZE = 151;

//namespace holding the path to the kanto pokemon images
namespace KantoImages {
...
/************************************************************************
* Kanto Class
* 	This class represents the Kanto region screen. It manages 8 attributes:
* 		ui, scrollArea, gridLayout, mainLayout, list, mainWidget,
*       pokemonDialog, regionVect
*************************************************************************/
class Kanto : public QMainWindow
{
    Q_OBJECT

public:
    //Constructor
    explicit Kanto(QWidget *parent = nullptr);
...
private:
    Ui::Kanto            *ui;           //The UI for the region
