 ...
 * ------------------------------------------------------------------------
 * UNOVA_AR_SIZE	: The size of the array/vector
 * ------------------------------------------------------------------------
 * USED FOR SPECIFIC VALUES
 * ------------------------------------------------------------------------
 * UNOVA_START	: The starting index in the region pokedex
 *************************************************************************/
const int UNOVA_AR_SIZE = 156;
const int UNOVA_START = 494;

//namespace holding the path to the unova pokemon images
namespace UnovaImages {
...
/************************************************************************
* Alola Class
* 	This class represents the Unova region screen. It manages 8 attributes:
* 		ui, scrollArea, gridLayout, mainLayout, list, mainWidget,
*       pokemonDialog, regionVect
*************************************************************************/
class Unova : public QMainWindow
{
    Q_OBJECT

public:
    //Constructor
    explicit Unova(QWidget *parent = nullptr);
...
private:
    Ui::Unova            *ui;           //The UI for the region
